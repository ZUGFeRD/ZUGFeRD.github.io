...
link:imprint.en.html[Inofficial] page on free Factur-X, Order-X and Deliver-X (and XRechnung) libraries and tools.

link:https://www.ferd-net.de/standards/zugferd[ZUGFeRD]/Factur-X is a standard to embed machine readable XML in electronic invoice PDFs.
...
* loca Open source AI/invoice recognition and ZUGFeRD/FX review+generation https://github.com/kyr0/easy-erechnung/
...
* Philip Helgers open-sourve-validator link:https://github.com/phax/phive[Phive] can validate almost any invoice XML, including XRechnung, unfortunately not covering PDF-hybrid formats. Plus he has published the link:https://github.com/phax/kaltblut[Kaltblut] Factur-X/ZUGFeRD Validator
...
=== Redaction
* Andreas Starkes original little python utility to link:https://github.com/ZUGFeRD/einvoice-anonymizer[remove personal data/anonymize] invoices 
* Valitool's https://github.com/valitoolorg/zebra and it's online version http://zebra.valitool.org/
* Philip Helgers XSLT based https://github.com/phax/ph-redact
...
* And there is a MIT licensed parser for the Factur-X/ZUGFeRD Spec https://github.com/S2-Industries/FactoorSharp.FacturXDocumentationParser publishing to http://doc.factoorsharp.com/
